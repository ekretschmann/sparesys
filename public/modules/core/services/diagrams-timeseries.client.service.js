...
/* global d3 */
angular.module('core').service('DiagramsTimeSeriesService', ['$timeout',
    function ($timeout) {


        //this.timeseries = function(spaced, data, enableBrush) {
        ...
        this.drawTimeSeries = function (cards, id, windowWidth) {
            ...
            //var height = (this.lessThanDay(padding.pad)) ? (100 - margin.top - margin.bottom) : (300 - margin.top - margin.bottom);
            //
            ...
            //    .attr('class', 'circ')
            //    .attr('cx', function(d) {
            //        return (this.lessThanDay(padding.pad)) ? x(d.value) : x(getDate(d.value));
            //    })
