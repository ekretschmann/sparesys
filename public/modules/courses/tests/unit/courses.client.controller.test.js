...
//
        ...
        it('$scope.create() with invalid form data should send a POST request with the form input values and then locate to new object URL', inject(function(Courses) {
            var sampleCoursePostData = new Courses({
                name: '',
                description: 'Description'
            });
            ...
            $httpBackend.expectPOST('courses', sampleCoursePostData).respond(500, {message: 'Error Message'});
